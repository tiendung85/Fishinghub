...
<div class="search-bar">
    ...
    <input type="text" name="search" placeholder="Search name or email..." value="${param.search != null ? param.search : ''}" />
    <select name="role">
                ...
                <c:forEach var="u" items="${userList}">
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="action-btn delete" href="deleteUser?userId=${u.userId}" onclick="return confirm('Delete user: ${u.fullName}?');">
   Delete
</a>
                        </td>
                    </tr>
