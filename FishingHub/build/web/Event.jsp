            ...
            <div class="container mx-auto px-4">
                ...
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                    ...
                    <div class="flex items-center justify-between gap-4">
                        <form action="SearchEvent" method="GET" class="flex items-center w-full max-w-lg">
                            ...
                            <button type="submit"
                                    class="bg-primary text-white px-4 py-2  hover:bg-blue-700 flex items-center justify-center">
                                <i class="ri-search-line"></i>
                            </button>
                        </form>
                        <!-- Create Event Button -->
                        <c:if test="${user.getRoleId()== 2}">
                            <a href="Event?action=create_event"
                ...
                <div class="bg-white rounded shadow-sm mb-8">
                    ...
                    <div class="flex border-b border-gray-200">
                        <button
                            class="tab-button px-6 py-4 text-gray-600 font-medium hover:text-primary" onclick="location.href = 'EventList'"> All Events </button>
                        <button
                            class="tab-button px-6 py-4 text-gray-600 font-medium hover:text-primary cursor-pointer"onclick="location.href = 'EventList?action=upcoming'">Up Coming Events</button>
                        <button class="tab-button px-6 py-4 text-gray-600 font-medium hover:text-primary"
                                onclick="location.href = 'EventList?action=ongoing'">Ongoing Events</button>
                        <button
                            class="tab-button px-6 py-4 text-gray-600 font-medium hover:text-primary" >My Events</button>
                    </div>
                </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                            ...
                            <div class="bg-white rounded shadow-md overflow-hidden border border-gray-100">
                                ...
                                <div class="p-5">
                                    ...
                                    <p class="text-gray-600 mb-4 line-clamp-2">A 5-day course with leading experts...</p>
                                    <div class="flex gap-4 mt-4">
                                        <button class="w-full bg-primary text-white py-2 rounded-button whitespace-nowrap">Register to Join</button>
                                        <a href="#" class="w-full bg-gray-200 text-gray-700 py-2 rounded-button whitespace-nowrap text-center hover:bg-gray-300">View</a>
                                    </div>
                                </div>
                            </div>
