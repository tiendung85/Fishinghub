...
<body>
    ...
    <!-- Create Event Box -->
    <div id="createEventBox" class="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50 hidden">
        <div class="bg-white rounded-lg shadow-lg p-8 w-full max-w-md relative">
            <button id="closeCreateEvent" class="absolute top-2 right-2 text-gray-400 hover:text-primary text-2xl">
            ...
            <form>
                <div class="mb-4">
                    ...
                    <input type="text" class="w-full border rounded px-3 py-2" placeholder="Enter event name">
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="w-full border rounded px-3 py-2" placeholder="Enter location">
                </div>
                <div class="mb-4">
                    <label class="block text-sm font-medium mb-1">Description</label>
                    <textarea class="w-full border rounded px-3 py-2" rows="3" placeholder="Describe the event"></textarea>
                </div>
                <button type="submit" class="bg-primary text-white px-4 py-2 rounded-button">Create Event</button>
            </form>
        </div>
    </div>
    <!-- Notification Panel -->
