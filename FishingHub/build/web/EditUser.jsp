                                    ...
                                    <td>
                                        <c:choose>
                                            <c:when test="${deniedPermissionsSet.contains(perm.permissionId)}">
                                                <input type="checkbox" name="denyPermission" value="${perm.permissionId}" checked />
                                            </c:when>
                                            <c:otherwise>
                                                <input type="checkbox" name="denyPermission" value="${perm.permissionId}" />
                                            </c:otherwise>
                                        </c:choose>
                                    </td>
                                </tr>
