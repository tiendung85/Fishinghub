...
<html lang="en">
    ...
    <h1 class="text-2xl font-bold mb-6">Sản phẩm từ shop: ${shopName}</h1>
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        <c:forEach var="product" items="${productList}">
            <div class="bg-white rounded-lg shadow p-4">
                ...
                <p class="text-gray-700 mb-2">Giá: ${product.price}₫</p>
                <p class="text-gray-500 mb-2">Đã bán: ${product.soldQuantity}</p>
                <form action="ProductServlet" method="POST">
                    <input type="hidden" name="productId" value="${product.productId}"/>
                    <button type="submit" name="btAction" value="addToCart" class="w-full bg-primary text-white py-2 rounded hover:bg-blue-600">
