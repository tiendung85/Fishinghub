    ...
    <body>
        ...
        <div class="container mx-auto px-4 py-8">
            ...
            <div class="bg-white shadow-md rounded-lg p-6 mb-8 flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-primary mb-2"><%= currentUser.getFullName() %></h1>
                    <p class="text-gray-600"><i class="ri-map-pin-line mr-2"></i>Địa điểm: <%= currentUser.getLocation() != null ? currentUser.getLocation() : "Chưa cập nhật" %></p>
                </div>
                ...
                <c:choose>
                    <c:when test="${not empty lakes}">
                        <c:forEach var="lake" items="${lakes}">
                            <button class="lake-btn bg-primary text-white px-4 py-2 rounded-button hover:bg-primary/90 focus:outline-none"
