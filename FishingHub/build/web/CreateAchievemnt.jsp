    ...
    <main class="container mx-auto px-4 py-6 min-h-[calc(100vh-160px)]">
        ...
        <div class="tab-content active" id="post-achievement">
            <div class="max-w-3xl mx-auto bg-white rounded-lg shadow-sm p-6 mb-6">
                <h2 class="text-2xl font-bold text-gray-800 mb-6 text-center">Đăng Thành Tích</h2>
                <div class="mb-8">
                    <h3 class="text-lg font-medium text-gray-700 mb-4">Tải lên ảnh thành tích của bạn</h3>
                    <div class="flex flex-col items-center justify-center w-full">
                        <label for="fish-image" class="w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 transition-colors flex flex-col items-center justify-center">
                            <div class="flex flex-col items-center justify-center pt-5 pb-6" id="upload-placeholder">
                                ...
                                <p class="mb-2 text-sm text-gray-500"><span class="font-medium">Nhấp để tải lên</span> hoặc kéo thả</p>
        ...
        <div class="mb-6">
            <div class="flex justify-between items-center mb-2">
                <label for="description" class="block text-lg font-medium text-gray-700">Mô tả thành tích</label>
                <span class="text-sm text-gray-500" id="char-count">0/200</span>
            </div>
            <textarea id="description" rows="4" class="w-full px-4 py-3 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary resize-none" placeholder="Chia sẻ thành tích của bạn..."></textarea>
        </div>
        <div class="flex justify-between items-center">
            <div class="flex items-center">
                ...
                <span class="font-medium" id="selected-points">0 điểm</span>
            </div>
            <button id="post-button" class="bg-primary text-white px-6 py-3 rounded-button font-medium hover:bg-blue-600 transition-colors whitespace-nowrap disabled:opacity-50 disabled:cursor-not-allowed" disabled>Đăng Thành Tích</button>
        </div>
    </main>
    <!-- Footer translation -->
