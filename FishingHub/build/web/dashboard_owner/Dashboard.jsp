                                            ...
                                            <div class="ml-5 w-0 flex-1">
                                                <dl>
                                                    ...
                                                    <dd class="flex items-baseline">
                                                        ...
                                                        <%-- Bạn có thể truyền thêm phần trăm tăng trưởng nếu muốn --%>
                                ...
                                <div class="bg-white overflow-hidden shadow rounded-lg">
                                    <div class="p-5">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-5 w-0 flex-1">
                                                <dl>
                                                    <dt class="text-sm font-medium text-gray-500 truncate">Đơn hàng mới</dt>
                                                    <dd class="flex items-baseline">
                                                        <div class="text-2xl font-semibold text-gray-900">
                                                            <%= request.getAttribute("newOrders") %>
                                                        </div>
                                                        <%-- Truyền thêm phần trăm nếu có --%>
                                                        <div class="ml-2 flex items-baseline text-sm font-semibold text-green-600">
                                                            +8.2%
                                                        </div>
                                                    </dd>
                        ...
                        <div class="mt-8 grid grid-cols-1 gap-5 lg:grid-cols-2">
                            ...
                            <div class="bg-white shadow rounded-lg p-5">
                                <div class="flex items-center justify-between mb-4">
                                    ...
                                    <div class="flex space-x-3">
                                        <button class="inline-flex items-center px-2.5 py-1.5 border border-gray-300 shadow-sm text-xs font-medium rounded text-gray-700 bg-white hover:bg-gray-50 focus:outline-none !rounded-button whitespace-nowrap">7 ngày</button>
                                        <button class="inline-flex items-center px-2.5 py-1.5 border border-transparent shadow-sm text-xs font-medium rounded text-white bg-primary hover:bg-indigo-700 focus:outline-none !rounded-button whitespace-nowrap">30 ngày</button>
                                        <button class="inline-flex items-center px-2.5 py-1.5 border border-gray-300 shadow-sm text-xs font-medium rounded text-gray-700 bg-white hover:bg-gray-50 focus:outline-none !rounded-button whitespace-nowrap">1 năm</button>
                                    </div>
                                </div>
                            ...
                            <div class="bg-white shadow rounded-lg overflow-hidden">
                                <div class="px-5 py-4 border-b border-gray-200">
                                    <div class="flex items-center justify-between">
                                        <h2 class="text-lg font-medium text-gray-900">Sự kiện đang diễn ra</h2>
                                        <a href="#" class="text-sm font-medium text-primary hover:text-indigo-800">Xem tất cả</a>
                                    </div>
                                </div>
