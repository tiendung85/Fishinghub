...
<html lang="vi">
                                                ...
                                                <tr class="hover:bg-gray-50 cursor-pointer"
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                        <div class="flex justify-end space-x-2">
                                                            <button type="button" class="text-primary hover:text-indigo-900"
                                                                    onclick="showOrderDetail(${order.id})">Xem</button>
                                                            <c:if test="${order.status.statusID == 1}">
                                                                <form action="Order" method="post" style="display:inline;">
                                                                    <input type="hidden" name="orderId" value="${order.id}" />
                                                                    <input type="hidden" name="statusId" value="2" />
                                                                    <button type="submit" class="px-3 py-1 bg-green-500 hover:bg-green-600 text-white rounded mr-2"
                                                                            onclick="return confirm('Chấp thuận đơn hàng này?')">
                                                                        Chấp thuận
                                                                    </button>
                                                                </form>
                                                                <form action="Order" method="post" style="display:inline;">
                                                                    ...
                                                                    <button type="submit" class="px-3 py-1 bg-red-500 hover:bg-red-600 text-white rounded"
    ...
    filterOrdersServer();
        ...
        <div id="order-detail-modal" style="display:none; position:fixed; z-index:1000; top:0; left:0; width:100vw; height:100vh; background:rgba(0,0,0,0.35); align-items:center; justify-content:center;">
            <div style="background:#fff; min-width:320px; max-width:90vw; padding:24px 16px; border-radius:12px; position:relative;">
                <button onclick="closeOrderDetailModal()" style="position:absolute; top:10px; right:12px; font-size:20px; background:none; border:none;">×</button>
                <div id="order-detail-content" style="max-height:60vh; overflow:auto;">
        ...
        <script>
                                            // Hiện popup chi tiết đơn hàng
                                                    ...
                                                    url: "OrderDetailAPI",
                                                            ...
                                                            error: function() {
                                                            $('#order-detail-content').html('<div style="color:red;">Không lấy được chi tiết đơn hàng.</div>');
                                                                    $('#order-detail-modal').css('display', 'flex');
                                                            }
                                                    });
                                                    }
