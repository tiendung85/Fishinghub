        ...
        try {
            switch (action == null ? "" : action) {
                case "add": {
                    ...
                    fish.setAverageWeightKg(request.getParameter("averageWeightKg") != null && !request.getParameter("averageWeightKg").isEmpty() ? Double.parseDouble(request.getParameter("averageWeightKg")) : 0.0);
                    fish.setLength(request.getParameter("averageLengthCm") != null && !request.getParameter("averageLengthCm").isEmpty() ? Double.parseDouble(request.getParameter("averageLengthCm")) : 0.0);
                ...
                case "edit": {
                    ...
                    if (commonName == null && idStr != null) {
                        ...
                        fish.setAverageWeightKg(avgWeight != null && !avgWeight.isEmpty() ? Double.parseDouble(avgWeight) : 0.0);
