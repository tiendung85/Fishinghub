...
%>
            ...
            <body>
                ...
                <!-- Hero Section -->
<!-- Hero Section dùng Swiper Slider -->
<section class="hero-section relative">
    <div class="swiper heroSwiper">
        <div class="swiper-wrapper">
            ...
            <!-- Slide 2: Bản đồ hồ câu cá -->
            <div class="swiper-slide">
                <div class="relative py-16 bg-cover bg-center bg-no-repeat" style="background-image: url('assets/img/fishing-map-demo.webp'); min-height: 440px;">
                    <div class="absolute inset-0 bg-black/50"></div>
                    <div class="container mx-auto px-4 w-full relative z-10 flex flex-col items-center justify-center h-full">
                        <h2 class="text-3xl md:text-4xl font-bold text-white mb-4 drop-shadow-lg text-center">Khám phá những hồ câu nổi tiếng xuất hiện trong khu vực của bạn!</h2>
                        <button onclick="window.location.href='FishingMap.jsp'" class="bg-primary text-white px-8 py-3 rounded-button font-semibold shadow hover:bg-primary/80 text-lg">Khám Phá Ngay</button>
                    </div>
                </div>
            </div>
        </div>
